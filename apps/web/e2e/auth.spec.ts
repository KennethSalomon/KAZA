...
test.describe('Auth flow', () => {
  test('register form renders with all fields', async ({ page }) => {
    ...
    await expect(page.getByLabel(/locataire/i)).toBeVisible();
    await expect(page.getByLabel(/bailleur/i)).toBeVisible();
  ...
  test('register requires consent checkbox', async ({ page }) => {
    ...
    await page.getByLabel(/locataire/i).check();
...
test.describe('Static pages', () => {
  test('confidentialite page is accessible', async ({ page }) => {
    ...
    await expect(page.getByText(/loi béninoise/i)).toBeVisible();
  });

  test('mentions legales page is accessible', async ({ page }) => {
