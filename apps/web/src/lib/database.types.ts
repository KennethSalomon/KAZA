...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      receipts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "receipts_signed_by_fkey"
            columns: ["signed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      visits: {
        ...
        Relationships: [
          {
            foreignKeyName: "visits_confirmed_by_fkey"
            columns: ["confirmed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "visits_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "conversations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "visits_proposed_by_fkey"
            columns: ["proposed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      _allowed_upload_mime: { Args: { p_mime: string }; Returns: boolean }
      _postgis_deprecate: {
      ...
      add_review: {
        Args: { p_comment?: string; p_rating: number; p_residence_id: string }
        Returns: undefined
      }
      ...
      list_my_leases: { Args: never; Returns: Json }
      list_my_payments: { Args: never; Returns: Json }
      list_my_receipts: { Args: never; Returns: Json }
      list_overdue_leases: {
        Args: never
        Returns: {
          days_overdue: number
      ...
      list_reviews: { Args: { p_residence_id: string }; Returns: Json }
      list_tenants: { Args: never; Returns: Json }
      list_upcoming_due: {
        Args: { days?: number }
        Returns: {
          due_on: string
